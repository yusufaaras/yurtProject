    ...
    <div className="min-h-screen bg-[var(--brand-cream)] text-[var(--brand-ink)]">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="grid h-auto w-full grid-cols-2 gap-2 rounded-2xl border border-black/10 bg-white/90 p-2 shadow-sm sm:grid-cols-4 lg:w-auto lg:grid-cols-8">
            ...
            <TabsTrigger value="kullanicilar" className="flex w-full items-center justify-center gap-2 rounded-xl px-2 py-2 data-[state=active]:bg-[var(--brand-olive)] data-[state=active]:text-[var(--brand-cream)]">
            ...
            <TabsTrigger value="yeni-kullanici" className="flex w-full items-center justify-center gap-2 rounded-xl px-2 py-2 data-[state=active]:bg-[var(--brand-olive)] data-[state=active]:text-[var(--brand-cream)]">
              <UserPlus className="w-4 h-4" />
              <span className="hidden sm:inline">Yeni Kullanıcı</span>
            </TabsTrigger>
            <TabsTrigger value="yurtlar" className="flex w-full items-center justify-center gap-2 rounded-xl px-2 py-2 data-[state=active]:bg-[var(--brand-olive)] data-[state=active]:text-[var(--brand-cream)]">
